...
public class Lecture2 {
    public static void main(String[] args) {
        ...
        // toString() - преобразует объект в строковое представление. Метод
        // автоматически вызывается JavaScript, когда объект нужно представить в
        // текстовом виде. Если метод не переопределён, то он возвращает строку формата
        // [object тип] , где тип — это строка, которая уточняет тип объекта.
        ...
        // import java.util.logging.*;
        Logger logger = Logger.getLogger(Lecture_02.class.getName()); // getLogger - получить регистратор
